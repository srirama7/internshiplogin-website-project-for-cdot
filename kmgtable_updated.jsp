...
<%
    ...
    System.out.println("this is username............................"+session.getAttribute("EMPNAME"));
            
    if (staffNo != null) {
        session.setAttribute("staffNo", staffNo);
        session.setAttribute("refStaffNo", staffNo);
    } else {
        staffNo = (String) session.getAttribute("staffNo");
    }
    
    // Correct way to retrieve EMPNAME from database
    String EMPNAME = null;
    ...
    System.out.println("At the very top of the page staffNoaaaaaaaaa:::::::::::::::::::::"+session.getAttribute("refStaffNo"));
//    String staffNo = session.getAttribute("refStaffNo").toString();
    System.out.println("At the very top of the page staffNo:::"+staffNo);
    // Later in the form
%>
...
if (refStaffNo == null) {
    refStaffNo = "Not Provided";
}
        %>
    
    <div class="user-info-container">
        <div class="user-details">
            <div>Reference Staff Number: <%= refStaffNo %></div>
             <div>reffered Name is: <%= EMPNAME %></div>  
             <div>Role Name is:REFFERED STAFF </div>  
        </div>
    ...
    <div id="userDetails" class="form-container">
        ...
        <form>
            ...
            <label>Internship requirement description: </label>
            <input type="text" id="internreq" required>
    ...
    <div id="academicDetails" class="form-container">
        ...
        <form action="savekmg1.jsp" method="post" onsubmit="return validateForm()">
            ...
            <select name="duration" required onchange="toggleDuration()">
                <option value="">Select</option>
            ...
            <div class="dialog-box">
                ...
                <div style="display: flex; align-items: center; gap: 20px;">
                    ...
                    <input type="number" id="jyear" name="jyear" min="2000" max="2025" oninput="validatejyear()" required style="width: 80px;">
                    </div>
                    <div style="display: flex; align-items: center; gap: 20px;">
                    <label for="years">Current Year:</label>
                    <input type="number" id="years" name="years" min="1" max="5" oninput="validateyears()" required style="width: 80px;">
                    </div>
                ...
                <!-- Year-based input fields -->
                <div id="years1" style="display: none;margin-bottom: 15px;gap:20px;" class="years-input">
                    <label>Year 1 Marks(in %):</label>
                    <input type="number" name="years1_marks" step="0.1" min="0" max="100">
                </div>
                <br>
                <div id="years2" style="display: none;margin-bottom: 15px;gap:20px;" class="years-input">
                    <label>Year 2 Marks(in %):</label>
                    <input type="number" name="years2_marks" step="0.1" min="0" max="100">
                </div>
                <br>
                <div id="years3" style="display: none;margin-bottom: 15px;gap:20px;" class="years-input">
                    <label>Year 3 Marks(in %):</label>
                    <input type="number" name="years3_marks" step="0.1" min="0" max="100">
                </div>
                <br>
                <div id="years4" style="display: none;margin-bottom: 15px;gap:20px;" class="years-input">
                    <label>Year 4 Marks(in %):</label>
                    <input type="number" name="years4_marks" step="0.1" min="0" max="100">
                </div>
    ...
    <div id="trainingDetails" class="form-container">
        ...
        <form action="savekmg1.jsp" method="post" onsubmit="return validateTrainingForm()">
            ...
            <input type="hidden" name="internreq" id="trainingHiddenInternreq">
            ...
            <input type="hidden" name="branch" id="trainingHiddenBranch">
            ...
            <input type="hidden" name="completedCourse" id="trainingHiddencompletedCourse">
            <input type="hidden" name="year" id="trainingHiddenYear">
            <input type="hidden" name="years" id="trainingHiddenYears">
            <input type="hidden" name="semester" id="trainingHiddenSemester">
            <input type="hidden" name="jyear" id="trainingHiddenjyear">
            <input type="hidden" name="fileToTransfer" id="trainingHiddenFile">
            <input type="hidden" name="cgpa" id="trainingHiddenCGPA">
            
            <input type="hidden" name="years1_marks" id="trainingHiddenyears1Marks">
            <input type="hidden" name="years2_marks" id="trainingHiddenyears2Marks">
            <input type="hidden" name="years3_marks" id="trainingHiddenyears3Marks">
            <input type="hidden" name="years4_marks" id="trainingHiddenyears4Marks">
...
// Add this to your existing DOM ready event or initialize function
document.addEventListener('DOMContentLoaded', function() {
    // Set up file input change listeners
    const fileInput = document.getElementById('fileToTransfer');
    if (fileInput) {
        fileInput.addEventListener('change', function() {
            // When the file input changes, reset the upload flag
            window.fileUploaded = false;
            
            // Update the upload status message if it exists
            const uploadStatus = document.getElementById('uploadStatus');
            if (uploadStatus) {
                uploadStatus.innerHTML = 'New file selected. Please click "Upload File" button before proceeding.';
                uploadStatus.style.color = 'red';
            }
        });
    }
    
    // Same for the second file input
    ...
    if (secondFileInput) {
        secondFileInput.addEventListener('change', function() {
            ...
            if (uploadStatus) {
                uploadStatus.innerHTML = 'New approval letter selected. Please click "Upload File" button before proceeding.';
                uploadStatus.style.color = 'red';
            }
        });
    }
...
document.addEventListener('DOMContentLoaded', function() {
 ...
 const username = sessionStorage.getItem('username');
    ...
    document.getElementById('usernameDisplay').textContent = "<%= EMPNAME %>";
