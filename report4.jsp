...
<html>
    ...
    <div class="button-container">
        <button class="back-button" onclick="window.location.href = 'kmgtable.jsp?form=userDetails'">Student Details</button>
        <button class="back-button" onclick="window.location.href = 'kmgtable.jsp?form=academicDetails'">Academic Details</button>
        <button class="back-button" onclick="window.location.href = 'kmgtable.jsp?form=training'">Training Details</button>
        <div class="dropdown">
        ...
        <div id="dataContainer"> 
                ...
                <%
                    try {
                        ...
                        String sql = "SELECT ID, internship_type, InternReq_ID, StudentName, MailId, address, MobileNo, " +
             "CourseType, CourseName, BranchName, InstitutionName, university, " +
             "durationType, completedCourse, completedYear,Joined_year, CurrentYear, CurrentSemister, " +
             "sem1_marks, sem2_marks, sem3_marks, sem4_marks, sem5_marks, sem6_marks, sem7_marks, sem8_marks, sem9_marks, sem10_marks, " +
             "year1_marks,year2_marks,year3_marks,year4_marks,CGPAOnDate, ResumeUploadedFlag, CollegeLetterUploadedFlag, " +
             "InterCompletionDate, additionalInfo, " +
             "uptby, uptOn " +
             "FROM kmg_interntrainee_data ORDER BY ID DESC";
