        ...
        <div id="dataContainer"> 
                ...
                <%
                    try {
                        ...
                        String sql = "SELECT ID, InternType, InternReq_ID, InternReq_DateTime, InternReq_Status, InternReq_Description, "
                                    + "InternTraineeDuration_Months, refStattNo, refStaffName, relationship, InternBioDataId, "
                                    + "guideStaffNo,uptby,uptOn "
                                    + "FROM kmg_internshiprequest ORDER BY ID DESC";
